...
| ai-memory | `2a85950ce8fa5c309fdc3adc481e98a02d824a9f` | `akitaonrails/ai-memory` | memory backend candidate; Rust+SQLite workspace; structural audit EA-01 complete; runtime PT-03 PASS (180 store tests + fault injection) |
